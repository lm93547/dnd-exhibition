...
import { Size, NumberSize, ResizableProps, State } from "../../globals";
import { Resizer, Direction } from "./resizer";
import calculateNewMax from "./utils/calculateNewMax";
import clamp from "./utils/clamp";
import isMouseEvent from "./utils/events/isMouseEvent";
import isTouchEvent from "./utils/events/isTouchEvent";
import findClosestSnap from "./utils/findClosestSnap";
import getStringSize from "./utils/getStringSize";
  ...
  renderResizer() {
    ...
    const resizers = Object.keys(enable).map((dir) => {
      if (enable[dir as Direction] !== false) {
        const selected = this.props.selected.get === this.props.imageTitle;
        return (
          <>
            {selected ? (
              <Resizer
                ...
                rotate={true}
                selected={{set: this.props.selected.set, get: this.props.selected.get}}
